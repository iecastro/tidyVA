...
Although accurate, this output is not very easy to work with. The major function in _tidyVA_: `shift_geo` will project and repositon Alaska and Hawaii. 
...
This aggregated data become easier to use than the 
