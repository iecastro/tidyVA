...
Although accurate, this output is not very easy to work with.  But, since this is now in tidy format, we can easily filter and manipulate the data. The major function in __tidyVA__: `shift_geo()` will project and repositon Alaska and Hawaii. 
...
__tidyVA__ also includes ggplot themes: `theme_map()` and `theme_va()`. 
